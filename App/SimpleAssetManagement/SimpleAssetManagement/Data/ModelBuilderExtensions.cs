    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Location>().HasData(
                new Location
                {
                    Location_Id = Guid.Parse("ea9967dc-fd31-4add-97c2-e499d92079bb"),
                    Location_Name = "R&D"
                }
            );
            modelBuilder.Entity<Manufacture>().HasData(
                new Manufacture
                {
                    Manufacture_Id = Guid.Parse("ca3bdc52-7a1a-4e72-b915-d35eca13666e"),
            ...
            modelBuilder.Entity<PippetteUser>().HasData(
                new PippetteUser 
                { 
                    Pippette_User_Id = Guid.Parse("ae30e17e-0a0e-4b9c-a6dc-7e442a6caecc"), 
